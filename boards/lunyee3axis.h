...
#define STEPPERS_ENABLE_PORT    (void *)GPIOA
#define STEPPERS_ENABLE_PIN     15

// Define homing/hard limit switch input pins.
#define LIMIT_PORT              (void *)GPIOB
...
#define AUXOUTPUT0_PORT         (void *)GPIOA // Spindle PWM
#define AUXOUTPUT0_PIN          8
#define AUXOUTPUT1_PORT         (void *)GPIOB // Spindle direction
#define AUXOUTPUT1_PIN          0
#define AUXOUTPUT2_PORT         (void *)GPIOB // Spindle enable
#define AUXOUTPUT2_PIN          1
#define AUXOUTPUT3_PORT         (void *)GPIOB // Coolant flood
#define AUXOUTPUT3_PIN          4
#define AUXOUTPUT4_PORT         (void *)GPIOB // Coolant mist
...
#define CONTROL_PORT            (void *)GPIOB
...
#define AUXINPUT0_PORT          (void *)GPIOB
#define AUXINPUT0_PIN           15
#define AUXINPUT1_PORT          (void *)GPIOB // Safety door
#define AUXINPUT1_PIN           8
#define AUXINPUT2_PORT          (void *)GPIOB // Reset/EStop
#define AUXINPUT2_PIN           5
#define AUXINPUT3_PORT          (void *)GPIOB // Feed hold
#define AUXINPUT3_PIN           6
#define AUXINPUT4_PORT          (void *)GPIOB // Cycle start
#define AUXINPUT4_PIN           7
#if N_ABC_MOTORS == 0
#define AUXINPUT5_PORT          (void *)GPIOA // Probe
